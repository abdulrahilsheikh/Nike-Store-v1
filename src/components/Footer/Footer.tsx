const Footer = () => {
	...
	return (
		<footer className="self-stretch w-full mt-14 bg-black">
			<div className="text-gray-500  px-4 py-5 max-w-screen-xl mx-auto md:px-8">
				<div className="gap-6 justify-between md:flex">
					<div className="flex-1">
						...
						<form onSubmit={(e) => e.preventDefault()}>
							...
							<div className="max-w-sm flex items-center  rounded-md   overflow-hidden">
								<input
									type="email"
									placeholder="Enter your email"
									className="w-full p-2.5 outline-none"
								/>
								<button className="p-2.5 rounded-md text-white bg-red-500 outline-none shadow-md focus:shadow-none sm:px-5 rounded-l-none font-bold ">
									Subscribe
								</button>
							</div>
						</form>
				...
				<div className="mt-8 py-6 border-t items-center justify-between sm:flex">
					<div className="mt-4 sm:mt-0">
						&copy; 2022 NiKe All rights reserved.
					</div>
